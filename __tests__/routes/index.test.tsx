...
vi.mock('lucide-react', async () => {
  ...
  const mocked = {} as Record<string, () => JSX.Element>;

  // Dynamically mock every named export (icon) to return a simple SVG
  for (const key of Object.keys(actual)) {
    mocked[key] = () => <svg data-testid={`icon-${key.toLowerCase()}`} />;
  }
